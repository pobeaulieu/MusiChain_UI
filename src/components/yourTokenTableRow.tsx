...
import styles from './yourTokenTAbleRow.module.css';



export default function YourTokenTableRow(props : any){
    ...
    <>
        <tr className={styles.row}>
            ...
            <td className={styles.cell}>{props.data.NbSharesOwned}</td>
